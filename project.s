...
next:	
	//stp d3, d4, [sp, #-16]!
	ldr x0, =temp_store
	printStr "\nEnter 2 to continue using same numbers for other operations"
	printStr "Enter 1 to input new numbers/ back to operations menu"
	printStr "Any number to go back Main Menu"
	bl get_input
